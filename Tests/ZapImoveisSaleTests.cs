...
{
    public class ZapImoveisSaleTests
    {
        ...
        [Fact]
        public async Task ZapImoveisReturnSale_RulesWorking_Exists()
        {
            SetupTestSaleWork();
        ...
        [Fact]
        public async Task ZapImoveisReturnSale_RentalWorking_Exists()
        {
            SetupTestRentalWork();
            var result = await Execute();
            Assert.Equal(result.Listings.Count == 1, true);
        ...
        [Fact]
        public async Task ZapImoveisReturnSale_RulesNotWorking_NotExists()
        {
        ...
        [Fact]
        public async Task ZapImoveisReturnSale_RentalNotWorking_NotExists()
        {
